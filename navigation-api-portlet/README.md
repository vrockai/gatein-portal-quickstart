<!--~ Do not edit this derived file! See gatein-portal-quickstarts-parent/src/main/freemarker/navigation-api-portlet/README.md.ftl ~-->
...
Summary: The very essence of every navigation portlet.  
...
3. Type this command to build and deploy the archive:
   ...
   This will deploy `target/navigation-api-portlet.war` to the running instance of the portal.
...
see the newly imported Navigation API Portlet under the navigation-api-portlet Category.
* Then you can add the example portlet to a page of your choice: either (a) to a new page or (b) to an existing page.
  * If you have chosen (a) to add the portlet to a new page:
    ...
    * In the Page Creation Wizard, fill in:
      * Node Name: navigation-api-portlet
      * Display Name: Navigation API Portlet
    * Click Next
